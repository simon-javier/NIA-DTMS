...
<div class="table-container">
    <form id="upload_docu_form" autocomplete="off" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control" id="description" name="description" rows="3" placeholder="Enter document description" name="description"></textarea>
            ...
            <div class="form-group">
                ...
                <input class="form-control" list="action_required_list" id="required_action" name="required_action" rows="3" placeholder="Action required" name="description">
            </div>
