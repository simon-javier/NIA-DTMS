        ...
        <tbody>
            <?php foreach($docu_details as $row){ ?>
                <tr style="background-color: #fff;">
                    ...
                    <td>
                        <a href="edit-document.php?id=<?php echo $row['id']; ?>" class="btn btn-danger"><i class='bx bx-pencil'></i></a>
                        <button class="btn btn-dark" data-id="<?php echo $row['id']; ?>" onclick="confirmPullRequest(event)"><i class='bx bx-git-pull-request'></i></button>
                    </td>
                </tr>
            <?php } ?>
