    ...
    <div class="d-flex justify-content-end align-items-end mb-3">
        ...
        <div class="dropdown">
            ...
            <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="dropdownIcon">
                <li><a class="dropdown-item" href="pulled-document.php"><i class='bx bx-show'></i> Pulled Documents</a>
                </li>
                <li><a class="dropdown-item" href="incomplete-document.php"><i class='bx bx-show'></i> Incomplete
                        Documents</a></li>
            </ul>
        </div>
    </div>
        ...
        <tbody>
            <?php foreach ($docu_details as $row) { ?>
                <tr style="background-color: #fff;">
                    ...
                    <td>
                        <a href="edit-document.php?id=<?php echo $row['id']; ?>" class="btn btn-danger"><i
                                class='bx bx-pencil'></i></a>
                        <button class="btn btn-dark" data-id="<?php echo $row['id']; ?>"
