    ...
    <div class="row">
        <div class="col-md-10 col-sm-10">
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="input1"
                    value="<?php echo $result['firstname']; ?> <?php echo $result['lastname']; ?>" placeholder="N/A"
                    readonly>
            </div>
        </div>
        <div class="col-md-2 col-sm-2">
            <div class="form-group">
                ...
                <p><span class="badge <?php echo ($result['status'] === 'active') ? 'badge-success' : 'badge-danger'; ?>"
        ...
        <div class="col-md-6">
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="input1" value="<?php echo $result['contact']; ?>"
                    placeholder="N/A" readonly>
            </div>
            <div class="form-group">
                <label for="input2">Position</label>
                <input type="text" class="form-control" value="<?php echo $result['position']; ?>" id="input2"
                    placeholder="N/A" readonly>
            </div>
        </div>
        <div class="col-md-6">
            <div class="form-group">
                ...
                <input type="text" class="form-control" value="<?php echo $result['email']; ?>" id="input4"
                    placeholder="N/A" readonly>
            </div>
            <div class="form-group">
                <label for="input5">Role</label>
                <input type="text" class="form-control" value="<?php echo $result['role']; ?>" id="input5"
                    placeholder="N/A" readonly>
            </div>
        </div>
        <div class="col-md-12">
            <div class="form-group">
                ...
                <input type="text" class="form-control" value="<?php echo $result['office']; ?>" id="input3"
                    placeholder="N/A" readonly>
            </div>
        </div>
