...
<div class="row p-4">
    ...
    <?php else: ?>
        <?php foreach ($statusPercentages as $officeName => $percentage): ?>
            <div class="border col-md-12 mb-4 p-4">
                <div class=" shadow-sm bg-white">
                    <h5 class="mb-3"><?php echo $officeName; ?></h5>
                    <div class="progress" style="height: 30px">
                        ...
                        ?>
                        <div class="progress-bar <?php echo $color; ?>" role="progressbar" style="width: <?php echo $percentage; ?>%;" aria-valuenow="100%" aria-valuemin="0" aria-valuemax="100"><?php echo $percentage; ?>%</div>
                    </div>
                </div>
            </div>
        <?php endforeach; ?>
