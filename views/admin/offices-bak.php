...
<div class="table-container">
    <div class="d-flex justify-content-end align-items-end mb-3">
        <a href="add-new-users.php?type=handler" class="btn btn-success d-flex align-items-center" style="gap: 10px"><i
                class='bx bx-plus-circle' style="font-size: 18px"></i> User</a>
        <div class="dropdown">
            <i class='bx bx-dots-vertical-rounded' style="font-size: 40px;" id="dropdownIcon" data-bs-toggle="dropdown"
                aria-expanded="false"></i>
            <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="dropdownIcon">
                <li><a class="dropdown-item" href="office-archived.php"><i class='bx bx-show'></i> Archived list</a>
                </li>
        ...
        <tbody>
            <?php foreach ($result as $row) { ?>
                <tr>
                    ...
                    <td>
                        <?php echo strlen($row['office']) > 10 ? substr($row['office'], 0, 10) . '...' : $row['office']; ?>
                    </td>
                    <td>
                    ...
                    <td>
                        <div class="dropdown">
                            ...
                            <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="userDropdown">
                                <li><a class="dropdown-item" href="user-details.php?id=<?php echo $row['id'] ?>"><i
                                            class='bx bx-show'></i> View Details</a></li>
                                <li><a class="dropdown-item" href="update-details.php?id=<?php echo $row['id'] ?>"><i
                                            class='bx bx-edit-alt'></i> Update Details</a></li>
                                <li><button class="dropdown-item" data-id="<?php echo $row['id'] ?>"
                                        onclick="updatePassword(this)"><i class='bx bx-lock'></i>
                                        Retrieve Account</button></li>
                                <li><button class="dropdown-item" data-id="<?php echo $row['id'] ?>"
                                        onclick="archiveAccount(this)"><i class='bx bxs-trash'></i>
                                        Archive Account</button></li>
                            </ul>
                        </div>
                    </td>
                </tr>
