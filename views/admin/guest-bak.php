...
<div class="table-container">
    <div class="d-flex justify-content-end align-items-end mb-3">
        <a href="add-new-users.php?type=guest" class="btn btn-success d-flex align-items-center" style="gap: 10px"><i
        ...
        <div class="dropdown">
            ...
            <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="dropdownIcon">
                <li><a class="dropdown-item" href="guest-archived.php"><i class='bx bx-show'></i> Archived list</a></li>
