...
<?php 
    try {
        //code...
        $trackDocument = "SELECT * from tbl_uploaded_document where uploader_id = :id and status = 'pending'";
            ...
            <?php foreach ($results as $row) { ?>
                <tr>
                    ...
                    <?php if($row['status'] == 'pending'){ ?>
                        <td><a href="document-details.php?id=<?php echo $row['id']; ?>&source=outgoing" class="btn btn-dark"><i class='bx bx-show'></i></a></td>
                    <?php }else{ ?>
