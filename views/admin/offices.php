...
<div class="d-flex justify-content-end align-items-end mb-3">
        <a href="add-new-users.php?type=handler" class="btn btn-success d-flex align-items-center" style="gap: 10px" ><i class='bx bx-plus-circle' style="font-size: 18px"></i> User</a>
        <div class="dropdown">
            ...
            <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="dropdownIcon">
                <li><a class="dropdown-item" href="office-archived.php"><i class='bx bx-show'></i> Archived list</a></li>
                ...
                <tr>
                    ...
                    <div class="dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="userDropdown">
                            ...
                            <li><button class="dropdown-item" data-id="<?php echo $row['id'] ?>" onclick="archiveAccount(this)" ><i class='bx bxs-trash' ></i>
