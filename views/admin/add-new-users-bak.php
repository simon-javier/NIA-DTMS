        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="firstName" name="firstName" placeholder="First name"
                        required oninput="checkForNumbers('firstName', 'error-firstname')">
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="lastName" name="lastName" placeholder="Last name"
                        required oninput="checkForNumbers('lastName', 'error-lastname')">
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="number" class="form-control" id="contact" name="contact"
                        placeholder="Format: 09123456789" required oninput="validateContactNumber()">
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="email" class="form-control" placeholder="Email address" id="email" name="email"
                        required oninput="validateEmails()">
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="email" class="form-control" placeholder="Email address" id="conemail" name="conemail"
                        required oninput="validateEmails()">
...
<script>
    ...
    function toggleFields() {
        ...
        if (type === "guest") {
            positionField.parentNode.parentNode.style.display = "none";
            officeField.parentNode.parentNode.style.display = "none";

            // Remove the 'required' attribute
            positionField.removeAttribute("required");
            officeField.removeAttribute("required");
        } else {
            positionField.parentNode.parentNode.style.display = "";
            officeField.parentNode.parentNode.style.display = "";
