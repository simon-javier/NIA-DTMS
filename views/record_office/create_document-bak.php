    ...
    <form accept-charset="UTF-8" id="upload_docu_form" autocomplete="off" enctype="multipart/form-data">
        ...
        <div class="row">
            <div class="col-md-10 form-group">
                ...
                <input type="text" placeholder="Sender name" class="form-control" name="from_external"
                    id="from_external" style="display: none;">
            </div>
            <div class="col-md-2 form-group">
                <div class="form-check d-flex align-items-center mt-4">
                    <input class="form-check-input" type="checkbox" onclick="checkExternal()" name="isexternal"
                        id="isexternal">
