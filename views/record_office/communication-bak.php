...
<div class="container">
    <div class="row">
        <div class="col-md-4" style="border-right: 2px solid #ddd; max-height: 75vh; overflow-y: scroll">
            <!-- Search Bar -->
            <input type="text" id="conversationSearch" style="width: 100%; padding: 10px"
            ...
            <div class="conversation-list">
                <?php if (empty($listOfreceiver)) { ?>
                    ...
                    foreach ($listOfreceiver as $row) { ?>
                        <a href="communication.php?convoid=<?php echo $row['conversationId']; ?>" class="items"
            ...
            <?php if (isset($_GET['convoid'])) {  ?>
                <div class="chat-container" id="chatContainer">
                    <div class="receiver-info d-flex align-item-center p-3">
                        <img src="<?php echo $env_basePath; ?>assets/user-profile/<?php echo $userProfile; ?>"
                            alt="User Image" style="border-radius: 50%; height: 50px; width: 50px">
                        <h4 style="margin-top: 10px; margin-left: 10px">
                            <?php echo $receiverFullname ?>
                        </h4>
                    </div>
                ...
                <form id="send-message-form">
                    <div class="input-container">
                        ...
                        <textarea id="messageInput" class="form-control" name="message" rows="3"
