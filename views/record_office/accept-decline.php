...
<div class="table-container">
        ...
        <div class="file col-md-12 mb-3">
            ...
            <div class="row mt-5">
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <br>
                    <strong><p>Transfered Date:</p></strong><p><?php echo date('F j, Y', strtotime($results['updated_at'])); ?></p>
                    <div class=" mt-3">
                    ...
                    <!-- <a href="<?php echo $env_basePath ?>assets/uploaded-pdf/<?php echo $results['pdf_filename']; ?>" target="_blank" class="btn btn-primary">
                            View
                    </a> -->
                </div>
                </div>
    ...
    <div class="d-flex justify-content-end align-item-end">
        <button class="btn btn-danger mr-3" data-id="<?php echo $id; ?>" onclick="declineDocument(event)">Decline</button>
        
        <!-- for internal document -->
        <?php if($from == 'internal'){ ?>
            <button class="btn btn-primary" data-id="<?php echo $id; ?>" onclick="acceptInternal(event)">Accept</button>
        <?php }else if($results['data_source'] == 'guest'){ ?>   
        <!-- for external document -->
            <button class="btn btn-primary" data-id="<?php echo $id; ?>" onclick="acceptExternal(event)">Accept</button>
            </div>
        <?php } ?>
</div>
...
<script>
    function acceptInternal(event) {
        ...
        Swal.fire({
            ...
            formData.append("action", "accept_document");
