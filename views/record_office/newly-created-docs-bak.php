        ...
        <tbody>
            ...
            <?php foreach ($results as $detail) { ?>
                <tr style="<?php
                    ...
                    <td style="text-align: end;">
                        <a href="accept-decline.php?id=<?php echo $detail['id']; ?>&from=external" class="btn btn-dark"><i
            ...
            <?php foreach ($results1 as $detail) { ?>
                <tr style="<?php
                    ...
                    <td style="text-align: end;">
                        <a href="accept-decline.php?id=<?php echo $detail['id']; ?>&from=internal" class="btn btn-dark"><i
                                class='bx bx-show'></i></a>
                    </td>
                </tr>
            <?php } ?>
