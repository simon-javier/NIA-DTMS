        ...
        <ul>
            ...
            <li>
                <a href="incoming-documents.php" class="navigation">
                    ...
                    <?php if ($num_rows > 0) { ?>
                        <span class="badge bg-success rounded-pill mr-3" style="color: white;">
                            <?php echo $num_rows; ?>
                        </span>
                    <?php } ?>
    ...
    <nav class="navbar active navbar-expand-lg">
        <div class="container-fluid">
            ...
            <div class="actions">
                ...
                <div class="btn-group">
                    <button type="button" class="btn btn-primary" id="openModalBtn" data-id="<?php echo $user_id; ?>"
                ...
                <div class="dropdown">
                    <img src="<?php echo $env_basePath; ?>assets/user-profile/<?php echo $userProfile['user_profile']; ?>"
                        alt="User Default Image" class="dropdown-toggle" id="userDropdown" data-bs-toggle="dropdown"
                        aria-expanded="false" style="height: 50px; width: 50px;">
                    <ul class="dropdown-menu" aria-labelledby="userDropdown" style="left: auto !important; right: 0;">
                        ...
                        <li><a class="dropdown-item"
                                href="<?php echo $env_basePath ?>views/settings/update-profile.php">Settings</a></li>
