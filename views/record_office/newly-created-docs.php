...
<table id="example" class="hover" style="width:100%">
    ...
    <tr style="<?php
        ...
        <td style="text-align: end;">
            <a href="accept-decline.php?id=<?php echo $detail['id']; ?>&from=external" class="btn btn-dark"><i class='bx bx-show'></i></a>
        </td>
    </tr>
<?php } ?>
...
<?php foreach ($results1 as $detail) { ?>
    <tr style="<?php
        ...
        <td style="text-align: end;">
            <a href="accept-decline.php?id=<?php echo $detail['id']; ?>&from=internal" class="btn btn-dark"><i class='bx bx-show'></i></a>
        </td>
    </tr>
<?php } ?>
