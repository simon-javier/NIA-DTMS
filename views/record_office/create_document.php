...
<div class="table-container">
    <form accept-charset="UTF-8" id="upload_docu_form" autocomplete="off" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control" list="action_required_list" id="required_action" name="required_action" placeholder="Action required" >
            </div>
            <div class="row">
                <div class="col-md-10 form-group">
                    <label for="from" id="from_label" style="display:none">From:</label>
                    <div id="internal-section">
                        <!-- <select name="from_internal" id="from_internal" class="form-control selectpicker" data-live-search="true" style="border: 2px solid green;">
                        <option value="" selected>Select</option>
                            <?php foreach($internaloffice as $office){ ?>
                                <option value="<?php echo $office['firstname']. ' ' . $office['lastname']; ?>" data-id="<?php echo $office['id']; ?>"><?php echo $office['firstname']. ' ' . $office['lastname']; ?> - <?php echo $office['office_code'] ?></option>
                            <?php } ?>
                        </select> -->
                        <input type="hidden" name="from_internal" id="from_internal" value="<?php echo $_SESSION['fullname'] ?>">
                        <input type="hidden" name="sender_id" id="sender_id" value="<?php echo $_SESSION['userid'] ?>">
                    </div>
                    
                    <input type="text" placeholder="Sender name" class="form-control" name="from_external" id="from_external" style="display: none;">
                </div>
                <div class="col-md-2 form-group">
                    <div class="form-check d-flex align-items-center mt-4">
                        <input class="form-check-input" type="checkbox" onclick="checkExternal()" name="isexternal" id="isexternal" >
