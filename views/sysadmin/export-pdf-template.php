    ...
    require '../../connection.php';
        ...
        if ($doc_type != 'Select') {
            ...
            if ($date_from != null && $date_to != null) {
                ...
                $selectDocumentQuery = "SELECT * FROM tbl_uploaded_document WHERE DATE(uploaded_at) BETWEEN :date_from AND :date_to AND document_type = :doc_type";
                ...
                $selectDocumentQuery = "SELECT * FROM tbl_uploaded_document WHERE document_type = :doc_type";
                $stmt = $pdo->prepare($selectDocumentQuery);
                $stmt->bindParam(':doc_type', $doc_type);
            ...
            $selectDocumentQuery = "SELECT * FROM tbl_uploaded_document";
            $stmt = $pdo->prepare($selectDocumentQuery);
...
<div class="button-container">
    <a href="generate-reports.php" class="button danger">Back</a>
    <button class="button primary" onclick="downloadAsPdf()">Save as PDF</button>
    <button class="button success" onclick="">Save as CSV</button>
</div>
<div class="container" id="capture" style="padding: 1rem">
    <h2 align="center" style="margin: 0;"><strong>Regional Irrigation Manager</strong></h2>
    <?php
