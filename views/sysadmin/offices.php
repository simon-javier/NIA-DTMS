...
<?php
     ...
     try {
         ...
         $get_user_data = "
             ...
             WHERE tbl_login_account.status = 'active' AND tbl_login_account.role != 'external' AND tbl_login_account.id != :id
         ";
...
<div class="d-flex justify-content-end align-items-end mb-3">
        <a href="add-new-users.php?type=internal" class="btn btn-success d-flex align-items-center" style="gap: 10px" ><i class='bx bx-plus-circle' style="font-size: 18px"></i> User</a>
</div>
