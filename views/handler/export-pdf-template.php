...
if ($doc_type != 'Select') {
    ...
    if ($date_from != null && $date_to != null) {
        ...
        $selectDocumentQuery = "SELECT * FROM tbl_uploaded_document WHERE DATE(uploaded_at) BETWEEN :date_from AND :date_to AND completed = :doc_type and from_office = :office";
        ...
        $selectDocumentQuery = "SELECT * FROM tbl_uploaded_document WHERE completed = :doc_type and from_office = :office";
        $stmt = $pdo->prepare($selectDocumentQuery);
        $stmt->bindParam(':doc_type', $doc_type);
        $stmt->bindParam(':office', $office);
    }
    ...
    $selectDocumentQuery = "SELECT * FROM tbl_uploaded_document WHERE from_office = :office and DATE(uploaded_at) BETWEEN :date_from AND :date_to";
    $stmt = $pdo->prepare($selectDocumentQuery);
    $stmt->bindParam(':date_from', $date_from);
    $stmt->bindParam(':date_to', $date_to);
    $stmt->bindParam(':office', $office);
    ...
    $selectDocumentQuery = "SELECT * FROM tbl_uploaded_document where from_office = :office";
    $stmt = $pdo->prepare($selectDocumentQuery);
    $stmt->bindParam(':office', $office);
}
$stmt->execute();
...
<body>
    <div class="button-container">
        <button onclick="window.history.back()" class="button danger">Back</button>
