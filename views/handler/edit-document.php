...
<div class="table-container">
    <a href="outgoing-documents.php" class="btn btn-danger mb-5">Back</a>
    ...
    <form id="update_docu" autocomplete="off" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="subject" name="subject" placeholder="Subject" name="subject" value="<?php echo $result['subject']; ?>">
            </div>
            ...
            <div class="form-group">
                ...
                <input type="date" class="form-control" id="document_date" name="document_date" placeholder="Document date" value="<?php echo $result['document_date']; ?>">
            </div>
            <div class="form-group">
                <label for="required_action">Action Required:</label>
                <input class="form-control" list="action_required_list" id="required_action" name="required_action" rows="3" placeholder="Action required" value="<?php echo $result['required_action']; ?>" name="description">
            </div>
            ...
            <div class="d-flex justify-content-end align-items-end" style="gap: 20px">
                <button type="submit" id="update_docu_btn" data-id="<?php echo $id; ?>" class="btn btn-primary" >Update</button>
