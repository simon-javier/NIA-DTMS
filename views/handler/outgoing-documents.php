            ...
            <td><img src="<?php echo $env_basePath; ?>assets/qr-codes/<?php echo $detail['qr_filename']; ?>" alt="QR Code" style="height: 80px"></td>
                ...
                <td style="text-align: end;">
                    ...
                    <?php if($detail['sender_id'] == $user_id && $detail['cur_office'] == 'No current office.'): ?>
                        <a href="edit-document.php?id=<?php echo $detail['id']; ?>" class="btn btn-danger"><i class='bx bx-pencil'></i></a>
                        <button class="btn btn-dark" data-id="<?php echo $detail['id']; ?>" onclick="confirmPullRequest(event)"><i class='bx bx-git-pull-request'></i></button>
                    <?php endif; ?>
                </td>
            </tr>
        <?php } ?>
