    ...
    <form id='generate_reports_form' action="export-pdf-template.php" method="get" autocomplete="off"
        ...
        <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
            ...
            <div class="sm:col-span-3">
                <label for="from" class="block text-sm/6 font-medium text-neutral-900">Date From:</label>
                <div class="mt-2">
            ...
            <div class="sm:col-span-3">
                <label for="dateto" class="block text-sm/6 font-medium text-neutral-900">Date To:</label>
                <div class="mt-2">
