...
<body>
    ...
    <div class="content">
        <div class="code d-flex justify-content-center align-item-center">
            <p>DOCUMENT CODE: <strong>
                    <?php echo $docu_detail['document_code'] ?>
                </strong></p>
        </div>
        ...
        <div class="subject d-flex">
            <img src="<?php echo $env_basePath; ?>assets/qr-codes/<?php echo $docu_detail['qr_filename'] ?>"
                alt="QR Code">
            <p class="mt-4">
                <?php echo $docu_detail['document_type'] ?> -
                <?php echo $docu_detail['subject'] ?>
            </p>
        </div>
            ...
            <div class="timeline">
                ...
                <?php foreach ($tracking_status as $status): ?>
                    <div class="containers <?php echo $currentPosition; ?>">
                        <div class="content">
                            <p>
                                <?php echo date('F j, Y', strtotime($status['timestamp'])); ?>
                            </p>
                            <p>
                                <?php echo htmlspecialchars($status['action_taken']); ?>
                            </p>
                            <p>By:
                                <?php echo htmlspecialchars($status['person']); ?>
                            </p>
                        </div>
                    </div>
                ...
                <div class="col-md-12">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="action" id="action"
                            value="<?php echo $docu_detail['required_action'] ?>" placeholder="Required Action" readonly
                            required>
                    </div>
                </div>
                ...
                <div class="col-md-12">
                    <div class="form-group">
                        ...
                        <textarea name="description" class="form-control" placeholder="Description" id="description"
                            ...
                            <?php echo $docu_detail['description'] ?>
                        </textarea>
                    </div>
                </div>
            </div>
        ...
        <div class="attachment">
            <div class="content d-flex align-item-center justify-content-between">
                <div class="d-flex align-item-center">
                    ...
                    <p class="mt-3">
                        <?php echo $docu_detail['document_size'] ?>
                    </p>
                </div>
                <div class="d-flex align-item-center">
        ...
        <div class="attachment">
            <div class="row">
                <div class="col-md-11">
                    <input type="text" id="action_taken" list="action_required_list" placeholder="Action taken"
                        class="form-control" name="action_taken" />
                </div>
                <div class="col-md-1">
                    <button class="btn btn-primary" data-id="<?php echo $id; ?>"
                        onclick="confirmTransfer(event)">Send</button>
                </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div id="pdfViewerContainer" style="height: 500px;">
                        <embed
                            src="<?php echo $env_basePath; ?>assets/uploaded-pdf/<?php echo $docu_detail['pdf_filename'] ?>"
